...
public:
	...
	SuperVectorT operator++(int)
	{
		SuperVectorT temp = *this;
		++(*this);
		return temp;
	}
	...
	friend std::ostream& operator<<(std::ostream& os, const SuperVectorT& vector)
	{
	...
	friend std::istream& operator>>(std::istream& is, SuperVectorT& vector)
	{
